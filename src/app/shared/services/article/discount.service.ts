  ...
  private arrArticle: Array<IArticle> = [
    {
      ...
      text: "Українські ІТ-спеціалісти поступово повертаються додому: у червні 2022 року 40% айтівців перебували в евакуації (в Україні чи за кордоном), а в березні таких було 61%. 27% фахівців переїхали в безпечніше місце в Україні, а 13% релокувалися за кордон.\n" +
        "\n" +
